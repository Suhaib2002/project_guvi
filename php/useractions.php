...
mysqli_query(get_connection(),"CREATE TABLE IF NOT EXISTS `guvi_assignment`.`users` (`id` INT NOT NULL AUTO_INCREMENT , `email` VARCHAR(256) NOT NULL , `password` VARCHAR(256) NOT NULL , `first_name` VARCHAR(256) NOT NULL , `last_name` VARCHAR(256) NOT NULL , `age` INT NOT NULL , `gender` VARCHAR(10) NOT NULL , `mobile` VARCHAR(25) NOT NULL, PRIMARY KEY (`id`), UNIQUE (`email`));");
